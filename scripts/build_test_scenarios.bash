...
PACKAGES=$(find src/github.com/openbankit/horizon/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
# PACKAGES=$(find src/github.com/openbankit/horizon/test/scenarios -iname 'kahuna.rb' -not -name '_common_accounts.rb')
...
gb generate github.com/openbankit/horizon/test/scenarios
# gb test github.com/openbankit/horizon/ingest
